function data_save(fp, t_c, body)
    ...
    fprintf(fp, '%3.7f, %3.7f, %3.7f, %3.7f,', body(1).ddqi_act, body(2).ddqi_act, body(3).ddqi_act, body(4).ddqi_act);
    ...
    fprintf(fp, '%3.7f, %3.7f, %3.7f, %3.7f,', body(1).ddqi, body(2).ddqi, body(3).ddqi, body(4).ddqi);
    fprintf(fp, '\n');
