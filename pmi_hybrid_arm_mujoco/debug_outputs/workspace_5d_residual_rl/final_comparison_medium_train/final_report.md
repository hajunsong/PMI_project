...
## 7. This run aggregate (mean over 50 paired episodes)
...
- Metrics: `debug_outputs/workspace_5d_residual_rl/final_comparison_medium_train/metrics/paired_metrics_50episodes.csv`, `debug_outputs/workspace_5d_residual_rl/final_comparison_medium_train/metrics/aggregate_metrics.md`
- Plots: `debug_outputs/workspace_5d_residual_rl/final_comparison_medium_train/plots` (including `seed_10000_*.png` for detail seed 10000)
- Videos: `debug_outputs/workspace_5d_residual_rl/final_comparison_medium_train/videos` (`seed_*_vsd_only.mp4`, `_sac_residual.mp4`, `_side_by_side.mp4`)
